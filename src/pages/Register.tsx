...
import { Bluetooth as Tooth, Mail, Lock, User, UserPlus, ArrowRight, AlertCircle, Phone } from 'lucide-react';
...
export const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent flex items-center justify-center p-6 relative overflow-hidden">
      {/* Background Decor */}
      <div className="absolute top-0 left-0 w-[50vw] h-[50vw] bg-gold/5 blur-[150px] rounded-full -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 right-0 w-[40vw] h-[40vw] bg-gold/5 blur-[150px] rounded-full translate-x-1/2 translate-y-1/2" />
      ...
      >
        <div className="text-center mb-12">
          ...
          <p className="text-white/40 uppercase tracking-widest text-[10px] font-bold">Register for exclusive dental care</p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-[32px] border border-white/10">
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest font-bold text-white/40 ml-4">Mobile Number</label>
              <div className="relative">
            ...
            >
              {loading ? <div className="w-5 h-5 border-2 border-black border-t-transparent rounded-full animate-spin" /> : <UserPlus className="w-5 h-5" />}
              Create Account
            </button>
          </form>
        </div>
